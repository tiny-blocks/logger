...
final class StructuredLoggerTest extends TestCase
{
    ...
    public function testLogWhenNoContextThenCorrelationIdIsEmpty(): void
    {
        ...
        self::assertMatchesRegularExpression('/correlation_id= level=/', $this->logStream->contents());
    }
    ...
    public function testLogWhenNoPayloadThenWritesEmptyDataArray(): void
    {
        ...
        self::assertStringContainsString('data=[]', $this->logStream->contents());
    }
    ...
    public function testLogWhenNoRedactionThenLeavesDataUnmodified(): void
    {
        ...
        self::assertStringContainsString('12345678900', $this->logStream->contents());
    }
    ...
    public function testBuildWhenNoStreamConfiguredThenUsesStderrFallback(): void
    {
        ...
        /** @Then the built logger implements the PSR-3 logger contract */
    ...
    public function testLogWhenContextDerivedThenOriginalOmitsCorrelationId(): void
    {
        ...
        /** @Then the original line does not carry the correlation ID */
    ...
    public function testRedactWhenNameIsMultibyteThenPrefixCountsCharacters(): void
    {
        ...
        self::assertStringContainsString('"name":"Üm**"', $this->logStream->contents());
    }
    ...
    public function testLogWhenContextBoundAtCreationThenWritesCorrelationId(): void
    {
        ...
        self::assertStringContainsString('correlation_id=req-initial', $this->logStream->contents());
    }
    ...
    public function testLogWhenPayloadIsUnencodableThenWritesEncodingFailure(): void
    {
        ...
        self::assertStringContainsString('data={"error":"encoding_failed"}', $this->logStream->contents());
    }
    ...
    public function testRedactWhenEmailStartsWithAtSignThenLeavesValueIntact(): void
    {
        ...
        self::assertStringContainsString('"email":"@example.com"', $this->logStream->contents());
    }
    ...
    #[DataProvider('passwordsOfVaryingLength')]
    public function testRedactWhenPasswordVariesInLengthThenMaskIsFixedWidth(string $password): void
    {
        ...
        $logger->info(message: 'login.attempt', context: ['password' => $password]);

        /** @Then the mask is a fixed-width run independent of the input length */
        self::assertStringContainsString('"password":"********"', $this->logStream->contents());
    }
    ...
    public function testRedactWhenPhoneIsMultibyteThenSuffixCountsCharacters(): void
    {
        ...
        self::assertStringContainsString('"phone":"*****ÿÿÿ"', $this->logStream->contents());
    }
    ...
    public function testRedactWhenDocumentIsMultibyteThenSuffixCountsCharacters(): void
    {
        ...
        /** @Then the visible suffix should contain whole characters, not bytes */
        self::assertStringContainsString('"document":"****ção"', $this->logStream->contents());
    }
    ...
    public function testRedactWhenEmailLocalPartIsMultibyteThenPrefixCountsCharacters(): void
    {
        ...
        self::assertStringContainsString('"email":"Üm**@example.com"', $this->logStream->contents());
    }
    ...
    public static function passwordsOfVaryingLength(): array
    {
        return [
            'short password' => ['123'],
            'long password'  => ['mySuperLongP@ssw0rd!123']
        ];
    }
}
